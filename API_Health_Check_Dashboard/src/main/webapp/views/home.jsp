...
<body>
	<h1 style="margin-left: 30%">Business and Environment Health
		Checks</h1>
	...
	%>
	<a
		href="http://localhost:3000/d/Joo3RxJ7k/brand1-api-1-dashboard?orgId=1&refresh=10s"
    ...
    ArrayList<double[]> list2 = caller.callAPI2();
    for (int i = 0; i < list2.size(); i++) {
		counter1 = counter1 + list2.get(i)[0];
		counter2 = counter2 + list2.get(i)[1];
		counter3 = counter3 + list2.get(i)[2];
	}
    counter1 = counter1 / iterations;
	counter2 = counter2 / iterations;
	counter3 = counter3 / iterations;
    ...
    <a
		href="http://localhost:3000/d/xsqjhVxnz/brand1-api-2-dashboard?orgId=1&refresh=10s"
		target="_blank" rel="noopener noreferrer"
		style="height: 50px;
    				width:20%;
    				background-color:<%out.println(status);%>;
    ...
    <%
    counter1=counter2=counter3=0;
    ArrayList<double[]> list3 = caller.callAPI3();
    for (int i = 0; i < list3.size(); i++) {
		counter1 = counter1 + list3.get(i)[0];
		counter2 = counter2 + list3.get(i)[1];
		counter3 = counter3 + list3.get(i)[2];
	}
    counter1 = counter1 / iterations;
	counter2 = counter2 / iterations;
	counter3 = counter3 / iterations;
    ...
    <a
		href="http://localhost:3000/d/BFvjr4bnk/brand1-api-3-dashboard?orgId=1&refresh=10s"
		target="_blank" rel="noopener noreferrer"
		style="height: 50px;
    				width:20%;
    				background-color:<%out.println(status);%>;
    ...
    <%
    counter1=counter2=counter3=0;
    ArrayList<double[]> list4 = caller.callAPI4();
    for (int i = 0; i < list4.size(); i++) {
		counter1 = counter1 + list4.get(i)[0];
		counter2 = counter2 + list4.get(i)[1];
		counter3 = counter3 + list4.get(i)[2];
	}
    counter1 = counter1 / iterations;
	counter2 = counter2 / iterations;
	counter3 = counter3 / iterations;
    ...
    <a
		href="http://localhost:3000/d/zRAl64bnk/brand1-api-4-dashboard?orgId=1&refresh=10s"
		target="_blank" rel="noopener noreferrer"
		style="height: 50px;
    				width:20%;
    				background-color:<%out.println(status);%>;
    ...
    <%
    counter1=counter2=counter3=0;
    ArrayList<double[]> list5 = caller.callAPI5();
    for (int i = 0; i < list5.size(); i++) {
		counter1 = counter1 + list5.get(i)[0];
		counter2 = counter2 + list5.get(i)[1];
		counter3 = counter3 + list5.get(i)[2];
	}
    counter1 = counter1 / iterations;
	counter2 = counter2 / iterations;
	counter3 = counter3 / iterations;
    ...
    <a
		href="http://localhost:3000/d/LnNjWSbnk/brand1-api-5-dashboard?orgId=1&refresh=10s"
		target="_blank" rel="noopener noreferrer"
		style="height: 50px;
    				width:20%;
    				background-color:<%out.println(status);%>;
